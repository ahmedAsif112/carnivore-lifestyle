            ...
            <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-3 sm:px-6 py-6 sm:py-10">
                <div className={`w-full max-w-2xl mx-auto transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <div className="text-center mb-8 sm:mb-12">
                        <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-r from-orange-400 to-red-500 rounded-full mx-auto mb-4 sm:mb-6 flex items-center justify-center shadow-xl animate-pulse">
                            <span className="text-2xl sm:text-3xl">🥩</span>
                        </div>
                        <h1 className="text-2xl sm:text-4xl font-bold text-white mb-3 sm:mb-4 tracking-wide px-2">
                            Crafting Your Perfect
                            <span className="block bg-gradient-to-r from-orange-300 to-red-300 bg-clip-text text-transparent">
                                Carnivore Journey
                            </span>
                        </h1>
                        <p className="text-orange-300 font-light text-base sm:text-lg px-4">
                            Personalizing your meat-based transformation plan
                        </p>
                    </div>

                    {/* Progress Card */}
                    <div className="bg-white/95 backdrop-blur-sm border-0 shadow-xl rounded-xl sm:rounded-2xl p-4 sm:p-8 mb-6 sm:mb-8 mx-2 sm:mx-0">
                    ...
                    <div className="text-center px-2 sm:px-0">
                        <div className="mb-4 sm:mb-6">
                            <p className="text-orange-200 font-medium text-sm sm:text-lg mb-2 px-2">
                        ...
                        <div className="bg-gradient-to-r from-orange-800/80 to-red-800/80 backdrop-blur-sm border border-orange-500/30 shadow-xl rounded-xl sm:rounded-2xl p-4 sm:p-6 max-w-sm sm:max-w-md mx-auto transition-all duration-500 hover:scale-105">
                            <div className="text-orange-100 text-base sm:text-lg italic font-light leading-relaxed">
                                {testimonials[testimonialIndex]}
                            </div>
                            <div className="mt-3 sm:mt-4 text-orange-300 text-xs sm:text-sm">
                    ...
                    <div className="mt-6 sm:mt-8 text-center px-2">
                        <div className="inline-flex items-center gap-2 sm:gap-3 bg-black/20 backdrop-blur-sm rounded-full px-4 sm:px-6 py-2 sm:py-3">
                            <div className="w-3 h-3 sm:w-4 sm:h-4 bg-orange-400 rounded-full animate-ping"></div>
                            <span className="text-orange-200 font-light text-sm sm:text-base">
